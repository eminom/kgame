...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$HIa7iUYEDQLt1rUOzVj2iQ$ip8FR+oHAYTxoKmcJz4Guw'
...
#  Choices: any of ['sha384', 'sha224', 'sha3_224', 'sha1', 'md5', 'sha256', 'sha3_384', 'blake2s', 'sha3_512', 'sha512', 'sha3_256', 'blake2b']
#  Default: 'sha256'
